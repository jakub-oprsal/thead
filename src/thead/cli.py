...
def get_args(args):
    ...
    parser.add_argument(
        "-o", "--out", metavar="OUTFILE", help="Output file", default=None
    )

    parser.add_argument("filename", help="The input metadata yaml file")
    ...
    parser.add_argument(
        "--bibstyle", help="Custom bibliography style", default=None
    )

    parser.add_argument("--recipe", help="Recipe in a yaml file", default=None)
